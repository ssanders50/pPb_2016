...
rm pPb_MB.lis
ls -1  /rfs/sanders/crab_projects/crab_pPb2016_pPb_MB1/* > pPb_MB.lis
...
cmsRun moveflatparamstodb_cfg.py print outputFile=HeavyIonRPRcd_pPb2016_pPb_MB.db outputTag=HeavyIonRPRcd begin=1 end=285832 infile="/rfs/sanders/EP_pPb_MB.root" rescor="RescorTables_pPb_MB"
rm /rfs/sanders/tmp_pPb_MB
