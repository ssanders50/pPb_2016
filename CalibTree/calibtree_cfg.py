...
process.evtPlaneCalibTree.useNtrk = cms.untracked.bool(True)

if ivars.ntrkMin == 0:
    process.p = cms.Path(process.collisionEventSelectionPA*process.olvFilter_pPb8TeV_dz1p0*process.minBias*process.hfCoincFilter*process.Noff*process.ppNoffFilterMB*process.hiEvtPlane* process.evtPlaneCalibTree )

if ivars.ntrkMin == 120:
    process.p = cms.Path(process.collisionEventSelectionPA*process.olvFilter_pPb8TeV_dz1p0*process.hltHM120*process.hfCoincFilter*process.Noff*process.ppNoffFilter120*process.hiEvtPlane* process.evtPlaneCalibTree )

if ivars.ntrkMin == 150:
    process.p = cms.Path(process.collisionEventSelectionPA*process.olvFilter_pPb8TeV_dz1p0*process.hltHM150*process.hfCoincFilter*process.Noff*process.ppNoffFilter150*process.hiEvtPlane* process.evtPlaneCalibTree )

if ivars.ntrkMin == 185:
    process.p = cms.Path(process.collisionEventSelectionPA*process.olvFilter_pPb8TeV_dz1p0*process.hltHM185*process.hfCoincFilter*process.Noff*process.ppNoffFilter185*process.hiEvtPlane* process.evtPlaneCalibTree )

if ivars.ntrkMin == 250:
    process.p = cms.Path(process.collisionEventSelectionPA*process.olvFilter_pPb8TeV_dz1p0*process.hltHM250*process.hfCoincFilter*process.Noff*process.ppNoffFilter250*process.hiEvtPlane* process.evtPlaneCalibTree )
